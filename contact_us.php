...
<p class="p2">Department Of Computer Science </p>
<p class="p3">SSBT COET<br>
Bambhori<br>
Jalagon - 425001<br>
Maharashtra (MH)<br><br></p>
<table>
<tr>
	<td>
	...
	<td >
    <p class="p2">Email:</p>emailus@ssbtcoet.ac.in<p class="p3"></p><br /><br />
...
the programmes of SSBT COET can register as our alumni.</p>
<p class="p2"><br>How do I become a member of the SSBT COET Alumni?</p>
<p class="p3">All undergraduates and post graduates of SSBT COET can register as
 our alumni. It is important for alumni to update their particulars for the SSBT COET Alumni
  Directory (Database) by register as a member online and pay at the counter of Alumni 
  SSBT COET so that we can keep in touch with you for life.</p>
